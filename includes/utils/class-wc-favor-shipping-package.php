...
/**
 * WC_Favor_Shipping_Package class.
 */
class WC_Favor_Shipping_Package {
	...
	public function get_data() {
		// Get the package data.
		$data = apply_filters( 'woocommerce_favor_default_package', $this->get_package_data() );
		...
		return array(
			'height' => apply_filters( 'woocommerce_favor_package_height', $cubage['height'] ),
			'width'  => apply_filters( 'woocommerce_favor_package_width', $cubage['width'] ),
			'length' => apply_filters( 'woocommerce_favor_package_length', $cubage['length'] ),
			'weight' => apply_filters( 'woocommerce_favor_package_weight', $data['weight'] ),
		);
	}
}